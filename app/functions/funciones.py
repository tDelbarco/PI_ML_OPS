...
def usuario_genero(genero):
    ...
    df_ug = df_ug.sample(5000)#redusco el df a una muestra aleatoria de 5 mil ya que no eh logrado optimizarla para que me corra correctamente pero quiero que retorne algo
